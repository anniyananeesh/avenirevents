<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Banners_management extends Admin_Controller {
...
|
*/
		protected $model_name 	= "model_banners_management";
		public $image_up_path 	= BANNERS_IMAGE_UP_PATH;
		public $thumb_up_path 	= BANNERS_THUMB_UP_PATH;
		public $image_show_path = BANNERS_IMAGE_PATH;
		public $thumb_show_path = BANNERS_THUMB_PATH;
		public $search_field 	= "title_en";
...
*/
        ...
        $title_fr 		= $this->input->post("title_fr", TRUE);
				...
				$is_exist_array   = array('title_en'=>$title_en);
...
*/
        ...
        $title_ar 		= $this->input->post("title_ar", TRUE);
				...
				$is_exist_array   = array('title_en'=>$title_en, 'id !='=>$record_id);
			...
			$data["title_en"] 		= stripslashes($data_record->title_en);
     	$data["title_ar"] 		= stripslashes($data_record->title_ar);
			$data["title_fr"] 		= stripslashes($data_record->title_fr);
