...
class Stylist_management extends Admin_Controller
{
    ...
    |
    */
    protected $model_name = "model_stylist_management";
    protected $model_countries = "model_country";

    public $image_up_path = STYLIST_IMAGE_UP_PATH;
