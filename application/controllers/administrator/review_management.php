<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Review_management extends Admin_Controller {
...
|
*/
		protected $model_name 	= "model_review_management";
		public $image_up_path 	= REVIEWS_IMAGE_UP_PATH;
		public $thumb_up_path 	= REVIEWS_THUMB_UP_PATH;
		public $image_show_path = REVIEWS_IMAGE_PATH;
		public $thumb_show_path = REVIEWS_THUMB_PATH;
...
*/
        ...
        $desig_en 		= $this->input->post("desig_en", TRUE);
				$desig_ar			= $this->input->post("desig_ar", TRUE);
        $desig_fr		= $this->input->post("desig_fr", TRUE);
        ...
        $description_fr 	= $this->input->post("description_fr", FALSE);
              ...
              "designation_en"		=>		mysql_real_escape_string($desig_en),
              "designation_ar"		=>		mysql_real_escape_string($desig_ar),
              "designation_fr"		=>		mysql_real_escape_string($desig_fr),
          ...
          $data["desig_en"] 		= $desig_en;
          $data["desig_ar"] 		= $desig_ar;
          $data["desig_fr"] 		= $desig_fr;
...
*/
      ...
      $data["desig_en"] 		= stripslashes($data_record->designation_en);
      $data["desig_ar"] 		= stripslashes($data_record->designation_ar);
      $data["desig_fr"] 		= stripslashes($data_record->designation_fr);
