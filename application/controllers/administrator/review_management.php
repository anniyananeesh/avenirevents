...
class Review_management extends Admin_Controller
{
    ...
    */
    public function add()
    {
        ...
        if (isset($_POST) && count($_POST) != 0) {
            ...
            $venue_en       = $this->input->post("venue_en", TRUE);
            ...
            if ($this->modelNameAlias->isExist($is_exist_array) == FALSE) {
                ...
                if ($uploadstatus != "Error") {
                    ...
                    $data_array = array(
                        ...
                        "venue_en" => mysql_real_escape_string($venue_en),
    ...
    */
    public function edit()
    {
        ...
        $data["venue_en"]       = stripslashes($data_record->venue_en);
        $data["description_en"] = stripslashes($data_record->description_en);
        $data["event_date"]     = stripslashes($data_record->event_date);
