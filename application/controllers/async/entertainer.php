...
class Entertainer extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->table               = TBL_ENTERTAINER;
        $this->image_up_path       = ENTERTAINER_IMAGE_UP_PATH;
        $this->image_thumb_up_path = ENTERTAINER_THUMB_UP_PATH;
        $this->user_images_table   = TBL_ENTERTAINER_IMAGES;
        $this->cv_up_path          = ENTERTAINER_CV_UP_PATH;

        $this->load->model('model_languages', 'modelLangAlias');
        $this->load->model('model_entertainer', 'modelNameAlias');
    ...
    public function upldCV()
    {
        ...
        if (isset($_FILES["cvFile"])) {
            ...
            if (!is_array($_FILES["cvFile"]["name"])) {
    ...
    public function setPhoto()
    {
        ...
        $save = array(
            $this->user_images_table . '.entertainer_fk' => $id,
        ...
        if(isset($_POST)) {
              ...
              if($record) {
                  ...
                  $data_message = array(
                      ...
                      'Specializations' => implode(',', unserialize($record->model_spl)),
                      'Other Specializations' => $record->model_spl_other,
                  ...
                  $this->email->subject(SITE_NAME . ' - New entertainer has been registered');
