...
class Stylist extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->table = TBL_STYLIST;
        $this->image_up_path = STYLIST_IMAGE_UP_PATH;
        $this->image_thumb_up_path = STYLIST_THUMB_UP_PATH;
        $this->user_images_table = TBL_STYLIST_IMAGES;
        $this->cv_up_path = STYLIST_CV_UP_PATH;

        $this->load->model('model_languages','modelLangAlias');
        $this->load->model('model_stylist', 'modelNameAlias');
    ...
    public function signup()
    {
        ...
        if(!$error)
        {
            ...
            $this->modelNameAlias->removeLangByModel($id);
    ...
    {
        return $this->modelNameAlias->hasUsername(array('email' =>$username));
    }
        ...
        if(isset($_POST)) {
              ...
              if($record) {
                  ...
                  $data_message = array(
                      ...
                      'Info other' => $record->model_info_other,
                  ...
                  $this->email->to(INFO_EMAIL);
                  $this->email->subject(SITE_NAME . ' - New Stylist has been registered');
                  ...
                  //Attach image
                  $photos = $this->modelNameAlias->getStylistPicsByPk($_POST['user']);
