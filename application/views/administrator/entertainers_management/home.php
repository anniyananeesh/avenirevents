			...
			<div class="list_header">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<tr>
							<td width="50%" align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/index/sort/first_name/by/<?=$sortby?><?=$urlparams?>/offset/<?=$offset?>" class="listHeading">Name (English) </a> <img src="<?=ADMIN_IMG_PATH?>/<?php echo ((isset($sort_heading_en))?$sort_heading_en:"sort_empty.png"); ?>" align="absmiddle" class="sort_image"/></td>
 						</tr>
						</table></td>
			...
			<div class="list">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="50%" align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/view/<? echo $value->id; ?>" title="Click to view details" class="listLink"><? echo $value->name; ?></a></td>
 							</tr>
						</table></td>
						<td width="60" align="center" valign="middle"></td>
