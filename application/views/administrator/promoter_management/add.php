          ...
          <div class="fieldTitle">Name : </div>
					...
					<div>
						<select name="model_info" id="model_info" class="textBox required">
							<option value="">Choose</option>
 							<option value="hostess" <?php echo ("hostess" == $model_info) ? 'selected':'';?>>Promoter / hostess</option>
 							<option value="promoter" <?php echo ("promoter" == $model_info) ? 'selected':'';?>>Promoter</option>
							<option value="new_face" <?php echo ("new_face" == $model_info) ? 'selected':'';?>>New Face</option>
						</select>
					</div>
					<div class="spacer">&nbsp;</div>

					<div class="fieldTitle">Preferences: </div>
					<div>
						<select name="model_pref[]" id="model_pref" multiple class="textBox required">

								<option value="automobile" <?php echo (!empty($model_pref) && in_array('automobile', $model_pref)) ? 'selected' : '';?>>Automobile</option>
								<option value="exhibitions" <?php echo (!empty($model_pref) && in_array('exhibitions', $model_pref)) ? 'selected' : '';?>>Exhibition</option>
								<option value="malls" <?php echo (!empty($model_pref) && in_array('malls', $model_pref)) ? 'selected' : '';?>>Malls</option>
								<option value="conferences" <?php echo (!empty($model_pref) && in_array('conferences', $model_pref)) ? 'selected' : '';?>>Conferences</option>
								<option value="supermarket" <?php echo (!empty($model_pref) && in_array('supermarket', $model_pref)) ? 'selected' : '';?>>Supermarket</option>
								<option value="weddings" <?php echo (!empty($model_pref) && in_array('weddings', $model_pref)) ? 'selected' : '';?>>Weddings</option>
								<option value="private_events" <?php echo (!empty($model_pref) && in_array('private_events', $model_pref)) ? 'selected' : '';?>>Private Events</option>
								<option value="gala_dinner" <?php echo (!empty($model_pref) && in_array('gala_dinner', $model_pref)) ? 'selected' : '';?>>Gala Dinner</option>
								<option value="tobacco" <?php echo (!empty($model_pref) && in_array('tobacco', $model_pref)) ? 'selected' : '';?>>Tobacco</option>
								<option value="alcohol" <?php echo (!empty($model_pref) && in_array('alcohol', $model_pref)) ? 'selected' : '';?>>Alcohol</option>
						</select>
					</div>
					<div class="spacer">&nbsp;</div>
