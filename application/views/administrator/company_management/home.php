			...
			<div class="list_header">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<tr>
							<td width="200" align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/index/sort/name/by/<?=$sortby?><?=$urlparams?>/offset/<?=$offset?>" class="listHeading">Name</a> <img src="<?=ADMIN_IMG_PATH?>/<?php echo ((isset($sort_heading_en))?$sort_heading_en:"sort_empty.png"); ?>" align="absmiddle" class="sort_image"/></td>
                            <td width="100" align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/index/sort/contact_no/by/<?=$sortby?><?=$urlparams?>/offset/<?=$offset?>" class="listHeading">Contact No. </a> <img src="<?=ADMIN_IMG_PATH?>/<?php echo ((isset($sort_heading_ar))?$sort_heading_ar:"sort_empty.png"); ?>" align="absmiddle" class="sort_image"/></td>
 						</tr>
						</table></td>
			...
			<div class="list">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="200" align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/view/<? echo $value->id; ?>" title="Click to view details" class="listLink"><? echo $value->name; ?></a></td>
                                <td width="100" align="left" valign="middle" class="arabic"><? echo $value->contact_no; ?></td>
 							</tr>
						</table></td>
