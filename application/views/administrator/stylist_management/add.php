					...
					<div>
						<select name="model_info" id="model_info" class="textBox required">
							<option value="">Choose</option>
 							...
 							<option value="makeup_artist" <?php echo ("makeup_artist" == $model_info) ? 'selected':'';?>>Makeup Artist</option>
							<option value="hair_make_up" <?php echo ("hair_make_up" == $model_info) ? 'selected':'';?>>Hair & Make Up</option>
							<option value="prop_stylist" <?php echo ("prop_stylist" == $model_info) ? 'selected':'';?>>Prop Stylist</option>
							<option value="wardrobe" <?php echo ("wardrobe" == $model_info) ? 'selected':'';?>>Wardrob</option>
