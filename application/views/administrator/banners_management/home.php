			...
			<div class="list_header">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<tr>
							<td align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/index/sort/title_en/by/<?=$sortby?><?=$urlparams?>/offset/<?=$offset?>" class="listHeading">Banner Title </a> <img src="<?=ADMIN_IMG_PATH?>/<?php echo ((isset($sort_title_en))?$sort_title_en:"sort_empty.png"); ?>" align="absmiddle" class="sort_image"/></td>
						</tr>
						</table></td>
						<td width="300" align="center" valign="middle">Image</td>
			...
			<div class="list">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="70" align="left" valign="middle">&nbsp;&nbsp;<a href="<?=HOST_URL?>/<?=$folder_name?>/edit/<?php echo $value->id; ?>"><img src="<?=ADMIN_IMG_PATH?>/edit.png" alt="Edit" border="0" /></a></td>
						<td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/view/<? echo $value->id; ?>" title="Click to view details" class="listLink"><? echo $value->title_en; ?></a></td>
							</tr>
						</table></td>
						<td width="300" align="center" valign="middle"><img src="<?=$image_path?>" width="200" class="thumb" border="0" /></td>
