...
<script>
	$(function() {
		...
		$('#btndeleteall').click(function(){
			 var x = confirm("Are you sure you want to clear all logs?");
		  if (x)
			  return true;
		  else
			return false;
...
<div class="page">
	...
	<div id="module">
		<div class="icon"><img src="<?=ADMIN_IMG_PATH?>/icon_settings_management.png" alt="<?=$module_name?>" /></div>
		<div><a href="<?=HOST_URL?>/<?=$folder_name?>" class="module_nameBig"><?php echo $module_name; ?></a></div>
		<div class="buttons">
			<ul class="actions">
				<li><input type="submit" name="btndeleteall" id="btndeleteall" value="Clear Logs" class="btn_delete" style="width:55px"></li>
	...
	<div class="contents">
		<div id="search_box">
			...
			<div class="float1">
			<select name="filter_by" id="filter_by" onchange="submitFormOnly()" class="listFilter" style="width:200px">
				<option value="All">Show All</option>
				<? foreach ($filterdata as $filter): ?>
				<option value="<?=$filter->id?>" <? if ($filter_by==$filter->id){ echo "selected='selected'"; } ?>><?=$filter->full_name?></option>
			 	<? endforeach; ?>
		  	</select>
		  	</div>
		...
		<div id="list">
			<div class="list_header">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<tr>
							<td align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/index/sort/description/by/<?=$sortby?><?=$urlparams?>/offset/<?=$offset?>" class="listHeading">Description </a> <img src="<?=ADMIN_IMG_PATH?>/<?php echo ((isset($sort_heading))?$sort_heading:"sort_empty.png"); ?>" align="absmiddle" class="sort_image"/></td>
						</tr>
						</table></td>
						<td width="200" align="center" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/index/sort/added_date/by/<?=$sortby?><?=$urlparams?>/offset/<?=$offset?>" class="listHeading">Date</a> <img src="<?=ADMIN_IMG_PATH?>/<?php echo ((isset($sort_added_date))?$sort_added_date:"sort_empty.png"); ?>" align="absmiddle" class="sort_image"/></td>
			...
			<div class="list">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="70" align="left" valign="middle">&nbsp;&nbsp; <a href="<?=HOST_URL?>/<?=$folder_name?>/delete/<?php echo $value->id; ?>"><img src="<?=ADMIN_IMG_PATH?>/delete.png" alt="Delete" border="0" /></a></td>
						<td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
			...
			<div class="header_bg text_align2">Version : <?php echo $this->module_version; ?></div>
