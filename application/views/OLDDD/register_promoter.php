...
myApp.controller('SignupCtrl',function($scope, $http, $window) {
    ...
    model_info: 'hostess',
		checkbox_model: {
				cars: 'YES',
				beauty: 'NO',
				alcoholic_beverages: 'NO',
				non_alcoholic_beverages: 'NO',
				cigarettes: 'NO',
				electronics: 'NO',
				other: 'NO'
		}
	...
	var settings = {
	    url: "<?php echo HOST_URL?>/async/upldCompanyPhotos",
	    dragDrop:false,
	    fileName: "myfile",
	    returnType:"json",
	    showDelete:true,
        ...
        onSuccess:function(files,data,xhr,pd)
		    {
				    ...
				    var request = $http({
								method: "post",
								url: "<?php echo HOST_URL?>/async/setCompanyPhoto",
								data: setParams,
  ...
  $scope.user_fullname = '';
	...
	$scope.submitForm = function(valid)
	{
      ...
      promotes: $scope.user.checkbox_model,
      ...
      <?php echo $this->security->get_csrf_token_name(); ?>: '<?php echo $this->security->get_csrf_hash(); ?>',
 		...
 		if(valid)
 		{
 			...
 			if($('#upload-container').children().length == 0)
 			{
 				...
 				var request = $http({
				    method: "post",
				    url: "<?php echo HOST_URL?>/async/promoter_signup",
				    data: params,
				    headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
				});
                ...
                <div class="col-md-6 <?php echo ($lan == 'ar') ? 'pull-right' : 'pull-left';?>">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label"><?php echo lang("auto.i_am")?></label> &nbsp;&nbsp;
	                                          ...
	                                          <input type="radio"  name="model_info" value="hostess" ng-checked="user.model_info == 'hostess'" ng-click="user.model_info = 'hostess'"> <?php echo lang("auto.hostess")?>
	                                        </label>
	                                        <label class="radio-inline">
	                                          <input type="radio"  name="model_info" value="beauty" ng-checked="user.model_info == 'beauty'" ng-click="user.model_info = 'beauty'"> <?php echo lang("auto.beauty")?>
	                                        </label>
	                                        <label class="radio-inline">
	                                          <input type="radio"  name="model_info" value="premium_promoter" ng-checked="user.model_info == 'premium_promoter'" ng-click="user.model_info = 'premium_promoter'"> <?php echo lang("auto.premium_promoter")?>
	                                        </label>
	                                         <label class="radio-inline">
	                                          <input type="radio"  name="model_info" value="secondary_promoter" ng-checked="user.model_info == 'secondary_promoter'" ng-click="user.model_info = 'secondary_promoter'"> <?php echo lang("auto.secondary_promoter")?>
	                                        </label>

                                    </div>

                                    <div class="form-group">
                                        <label class="control-label"><?php echo lang("auto.i_like_promote")?></label> &nbsp;&nbsp;

																				<label class="radio-inline">
	                                          <input type="checkbox"  name="promotes" value="cars" ng-model="user.checkbox_model.cars" ng-true-value="'YES'" ng-false-value="'NO'"> <?php echo lang("auto.cars")?>
	                                        </label>
	                                        <label class="radio-inline">
	                                          <input type="checkbox"  name="promotes" value="beauty" ng-model="user.checkbox_model.beauty" ng-true-value="'YES'" ng-false-value="'NO'"> <?php echo lang("auto.beauty")?>
	                                        </label>
	                                        <label class="radio-inline">
	                                          <input type="checkbox"  name="promotes" value="alcoholic_beverages" ng-model="user.checkbox_model.alcoholic_beverages" ng-true-value="'YES'" ng-false-value="'NO'"> <?php echo lang("auto.alcoholic_beverages")?>
	                                        </label>
	                                         <label class="radio-inline">
	                                          <input type="checkbox"  name="promotes" value="non_alcoholic_beverages" ng-model="user.checkbox_model.non_alcoholic_beverages" ng-true-value="'YES'" ng-false-value="'NO'"> <?php echo lang("auto.non_alcoholic_beverages")?>
	                                        </label>
	                                        <label class="radio-inline">
	                                          <input type="checkbox"  name="promotes" value="cigarettes" ng-model="user.checkbox_model.cigarettes" ng-true-value="'YES'" ng-false-value="'NO'"> <?php echo lang("auto.cigarettes")?>
	                                        </label>
	                                        <label class="radio-inline">
	                                          <input type="checkbox"  name="promotes" value="electronics" ng-model="user.checkbox_model.electronics" ng-true-value="'YES'" ng-false-value="'NO'"> <?php echo lang("auto.electronics")?>
	                                        </label>
	                                        <label class="radio-inline">
	                                          <input type="checkbox"  name="promotes" value="other" ng-model="user.checkbox_model.other" ng-true-value="'YES'" ng-false-value="'NO'"> <?php echo lang("auto.other")?>
	                                        </label>
