...
myApp.controller('SignupCtrl',function($scope, $http, $window) {
	...
	var settings = {
	    url: "<?php echo HOST_URL?>/async/model/upldPhotos",
	    dragDrop:false,
	    fileName: "myfile",
	    returnType:"json",
	    showDelete:true,
        ...
        onSuccess:function(files,data,xhr,pd)
		{
		    ...
		    var request = $http({
				method: "post",
				url: "<?php echo HOST_URL?>/async/model/setPhoto",
				data: setParams,
	...
	var CVsettings = {
	    url: "<?php echo HOST_URL?>/async/model/upldCV",
	    dragDrop:false,
	    fileName: "cvFile",
	    returnType:"json",
	    showDelete:true,
      ...
      <?php echo $this->security->get_csrf_token_name(); ?>: '<?php echo $this->security->get_csrf_hash(); ?>',
 		...
 		if(valid)
 		{
 			...
 			if($('#upload-container').children().length == 0)
 			{
 				...
 				var request = $http({
				    method: "post",
				    url: "<?php echo HOST_URL?>/async/model/signup",
				    data: params,
				    headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
				});
                ...
                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                          <input type="radio"  name="model_info" value="celebrity" ng-checked="user.model_info == 'celebrity'" ng-click="user.model_info = 'celebrity'"> Celebrity
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio"  name="model_info" value="international" ng-checked="user.model_info == 'international'" ng-click="user.model_info = 'international'"> International
                                        </label>
                                         <label class="radio-inline">
                                          <input type="radio"  name="model_info" value="national" ng-checked="user.model_info == 'national'" ng-click="user.model_info = 'national'"> National
                                        </label>
                                        <label class="radio-inline">
