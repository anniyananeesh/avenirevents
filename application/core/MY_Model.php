...
/*
|--------------------------------------------------------------------------
| This function Returns Table Name : Used in modules management
|--------------------------------------------------------------------------
*/	
...
*/
		...
		public function get_records_list($where_array, $where_or_array, $limit, $offset, $sort, $by){
			$this->db->select('*');
			$this->db->from($this->table_name);
			if (isset($where_or_array)){
...
/*
|--------------------------------------------------------------------------
| This function return record details with User Id
|--------------------------------------------------------------------------
*/
		public function get_details_uid($user_id){
...
/*
|--------------------------------------------------------------------------
| This function return record details with selected parameters
|--------------------------------------------------------------------------
*/
		public function get_detail($param_array){
			$this->db->select("*");
			$this->db->from($this->table_name);
			if (isset($param_array)){
				$this->db->where($param_array);
...
/*
|--------------------------------------------------------------------------
| This function Returns Records 
|--------------------------------------------------------------------------
*/
		public function get_records($param_array){
			$this->db->select('*');
			$this->db->from($this->table_name);
			if (isset($param_array)){
				$this->db->where($param_array);
...
|--------------------------------------------------------------------------
*/		
		public function get_or_detail($param_array, $param_or_array){
			$this->db->select("*");
			$this->db->from($this->table_name);
			if (isset($param_or_array)){
				$this->db->or_where($param_or_array);
			}
			if (isset($param_array)){
				$this->db->where($param_array);
			}
