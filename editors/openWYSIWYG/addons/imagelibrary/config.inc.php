 ...
 */
//$imagebasedir = $_SERVER['DOCUMENT_ROOT'].'/editors/openWYSIWYG/uploads';  // working Perfect
$imagebasedir = $_SERVER['DOCUMENT_ROOT'].'/images/uploads';

/*
 * An absolute or relative URL to the image folder.
 * This url is used to generate the source of the image.
 */
//$imagebaseurl = "http://".$_SERVER['HTTP_HOST']."/editors/openWYSIWYG/uploads"; // working Perfect
$imagebaseurl = "http://".$_SERVER['HTTP_HOST']."/images/uploads";
