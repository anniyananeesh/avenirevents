...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "<?=HOST_URL?>/editors/openWYSIWYG/images/";
		
		// Popups Directory
		this.PopupsDir = "<?=HOST_URL?>/editors/openWYSIWYG/popups/";
		
		// CSS Directory File
		this.CSSFile = "<?=HOST_URL?>/editors/openWYSIWYG/styles/wysiwyg.css";		
