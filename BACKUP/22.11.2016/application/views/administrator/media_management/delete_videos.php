<div class="page">
	<?php echo form_open(HOST_URL."/".$folder_name."/delete_videos/".$parent_id, 'name="frmListing" id="frmListing"'); ?>
	<div id="module">
		<div class="icon"><img src="<?=ADMIN_IMG_PATH?>/icon_<?php echo $folder_name; ?>.png" alt="<?=$module_name?>" /></div>
		<div><a href="<?=HOST_URL?>/<?=$folder_name?>" class="module_nameBig"><?php echo $module_name; ?> : Delete Videos</a></div>
		<div class="buttons">
			<ul class="actions">
				<li><input type="submit" name="btnsubmit" id="btnsubmit" value="Delete" class="btn_delete" ></li>
				<a href="<?=HOST_URL?>/<?=$folder_name?>/manage_videos/<?=$parent_id?>"><li>
			...
			<div class="list_header">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<tr>
							<td align="left" valign="middle">Video URL</td>
						</tr>
						</table></td>
			...
			<div class="list">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="left" valign="middle"><? echo $value->video_title; ?></td>
							</tr>
						</table></td>
