<div class="page">
	<?php echo form_open(HOST_URL."/".$folder_name."/delete_images/".$parent_id, 'name="frmListing" id="frmListing"'); ?>
	<div id="module">
		<div class="icon"><img src="<?=ADMIN_IMG_PATH?>/icon_<?php echo $folder_name; ?>.png" alt="<?=$module_name?>" /></div>
		<div><a href="<?=HOST_URL?>/<?=$folder_name?>" class="module_nameBig"><?php echo $module_name; ?> : Delete Images</a></div>
		<div class="buttons">
			<ul class="actions">
			...
			<div class="list_header">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<tr>
							<td align="left" valign="middle">Image Name</td>
						</tr>
						</table></td>
						<td width="100" align="center" valign="middle">Image</td>
			...
			<div class="list">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="left" valign="middle"><? echo $value->title; ?></td>
							</tr>
						</table></td>
						<td width="100" align="center" valign="middle"><img src="<?=$image_path?>" width="80" class="thumb" border="0" /></td>
