...
<div class="page">
	...
	<div id="module">
		...
		<div><a href="<?=HOST_URL?>/<?=$folder_name?>" class="module_nameBig">Admin Users Management</a></div>
		<div class="buttons">
			<ul class="actions">
			...
			<div class="list_header">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<tr>
							<td width="50%" align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/index/sort/full_name/by/<?=$sortby?><?=$urlparams?>/offset/<?=$offset?>" class="listHeading">Full Name </a> <img src="<?=ADMIN_IMG_PATH?>/<?php echo ((isset($sort_full_name))?$sort_full_name:"sort_empty.png"); ?>" align="absmiddle" class="sort_image"/></td>
							<td align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/index/sort/user_type/by/<?=$sortby?><?=$urlparams?>/offset/<?=$offset?>" class="listHeading">User Type </a> <img src="<?=ADMIN_IMG_PATH?>/<?php echo ((isset($sort_user_type))?$sort_user_type:"sort_empty.png"); ?>" align="absmiddle" class="sort_image"/></td>
						</tr>
						</table></td>
			...
			<div class="list">
				<?php
					foreach($data_list as $key=>$value){
						...
						$uType		  = ($user_type=="A" ? "Administrator" :  "System Admin");
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="70" align="left" valign="middle">&nbsp;&nbsp;<? if ($is_default=="N"){ ?><a href="<?=HOST_URL?>/<?=$folder_name?>/edit/<?php echo $value->id; ?>"><? } ?><img src="<?=ADMIN_IMG_PATH?>/edit.png" alt="Edit" border="0" /><? if ($is_default=="N"){ ?></a> <a href="<?=HOST_URL?>/<?=$folder_name?>/delete/<?php echo $value->id; ?>"><? } ?><img src="<?=ADMIN_IMG_PATH?>/delete.png" alt="Delete" border="0" /><? if ($is_default=="N"){ ?></a><? } ?></td>
						<td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="50%" align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/view/<? echo $value->id; ?>" title="Click to view details"><? echo $value->full_name; ?></a> <span class="published"><?=$default?></span></td>
								<td align="left" valign="middle"><? echo $uType; ?></td>
							</tr>
						</table></td>
