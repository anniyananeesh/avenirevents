		...
		<div id="panel">
			<div class="left-colum">
				<div class="col-contents">
					...
					<div class="fieldTitle">Heading (French) : </div>
					...
					<div class="clear"><?php echo form_textarea('description_sm_ar', $description_sm_ar, 'id="description_sm_ar" style="height:60px; width:80%;" class="textArea arabic text_align2 required"'); ?></div>

					<div>
                                            <div class="fieldTitle">Description Small (French) : </div>
					</div>
					<div class="clear"><?php echo form_textarea('description_sm_fr', $description_sm_fr, 'id="description_sm_fr" style="height:60px; width:80%;" class="textArea required"'); ?></div>
