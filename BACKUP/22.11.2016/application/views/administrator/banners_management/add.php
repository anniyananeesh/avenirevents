	...
	<div class="contents">
		...
		<div id="panel">
          ...
          <div class="fieldTitle">Banner Title (Arabic) : </div>
					...
					<div class="fieldTitle">Banner Title (French) : </div>
					<div><?php echo form_input('title_fr',$title_fr, 'id="title_fr" class="textBox required"'); ?></div>
					<div class="spacerBig">&nbsp;</div>
					...
					<div id="options-header">
						<div class="options_title">Images (width = 1920px, Height = 685px)</div>
