		...
		<div id="panel">
			<div class="left-colum">
				<div class="col-contents">
					<div class="detailTitle">Banner Title : </div>
					<div class="fieldValue"><?php echo $data_record->title_en; ?></div>
					<div class="spacerBig">&nbsp;</div>

					<div class="detailTitle">Banner Title Arabic: </div>
					<div class="fieldValue"><?php echo $data_record->title_ar; ?></div>
					<div class="spacerBig">&nbsp;</div>

					<div class="detailTitle">Banner Title French: </div>
					<div class="fieldValue"><?php echo $data_record->title_fr; ?></div>
					<div class="spacerBig">&nbsp;</div>
                    <div class="spacerBig">&nbsp;</div>
                    <!-- ********** IMAGES SECTION ********** -->
