			...
			<div class="list_header">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<tr>
							<td align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/index/sort/heading/by/<?=$sortby?><?=$urlparams?>/offset/<?=$offset?>" class="listHeading">Heading </a> <img src="<?=ADMIN_IMG_PATH?>/<?php echo ((isset($sort_heading))?$sort_heading:"sort_empty.png"); ?>" align="absmiddle" class="sort_image"/></td>
						</tr>
						</table></td>
			...
			<div class="list">
				<?php
					foreach($data_list as $key=>$value){
						...
						$image_path   = (!empty($image1_name) ? $this->image_show_path.'/'.$image1_name : ADMIN_IMG_PATH."/no_admin_image.png");						
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="left" valign="middle"><a href="<?=HOST_URL?>/<?=$folder_name?>/view/<? echo $value->id; ?>" title="Click to view details" class="listLink"><? echo $value->heading_en; ?></a></td>
							</tr>
						</table></td>
