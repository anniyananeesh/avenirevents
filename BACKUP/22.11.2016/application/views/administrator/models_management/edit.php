	        ...
	        <div class="fieldTitle">Name : </div>
					...
					<div>
						...
						<select name="promotes[]" id="promotes" multiple class="textBox required">
								...
								<option value="cars" <?php echo (is_array($promotes) && !empty($promotes) && in_array("cars", $promotes)) ? 'selected' : '';?>>Cars</option>
								<option value="beauty" <?php echo (is_array($promotes) && !empty($promotes) && in_array("beauty", $promotes)) ? 'selected' : '';?>>Beauty</option>
								<option value="alcoholic_beverages" <?php echo (is_array($promotes) && !empty($promotes) && in_array("alcoholic_beverages", $promotes)) ? 'selected' : '';?>>Alcoholic beverages</option>
								<option value="non_alcoholic_beverages" <?php echo (is_array($promotes) && !empty($promotes) && in_array("non_alcoholic_beverages", $promotes)) ? 'selected' : '';?>>Non alcoholic beverages</option>
								<option value="cigarettes" <?php echo (is_array($promotes) && !empty($promotes) && in_array("cigarettes", $promotes)) ? 'selected' : '';?>>Cigarettes</option>
								<option value="electronics" <?php echo (is_array($promotes) && !empty($promotes) && in_array("electronics", $promotes)) ? 'selected' : '';?>>Electronics</option>
								<option value="other" <?php echo (is_array($promotes) && !empty($promotes) && in_array("other", $promotes)) ? 'selected' : '';?>>Other</option>
