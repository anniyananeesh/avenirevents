                  ...
                  <option value="tinyMCE" <? if ($editor=="tinyMCE"){ echo "selected='selected'"; }?>>tinyMCE</option>
                    ...
                    <div class="spacer" style="height:30px;">&nbsp;</div>
					                    ...
					                    <div class="spacer" style="height:30px;">&nbsp;</div>
															...
															<div class="fieldTitle">Address (French): </div>
															<div><?php echo form_textarea('cn_address_fr',$cn_address_fr, 'id="cn_address_fr" class="textBoxSmall" style="width:250px;"'); ?></div>
										                    <div class="spacer" style="height:30px;">&nbsp;</div>
