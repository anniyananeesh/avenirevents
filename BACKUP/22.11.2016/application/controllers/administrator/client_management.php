...
class Client_management extends Admin_Controller
{
    ...
    |
    */
    protected $model_name = "model_client_management";
    public $image_up_path = CLIENT_IMAGE_UP_PATH;
    public $image_show_path = CLIENT_IMAGE_PATH;
    public $thumb_up_path = CLIENT_THUMB_UP_PATH;
    public $thumb_show_path = CLIENT_THUMB_PATH;
    ...
    */
    public function edit()
    {
        ...
        $data["link"] = stripslashes($data_record->link);
